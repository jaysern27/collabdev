...
if (results.length == 1) {
// Only one match: go straight to Cultural Map, centre on it,
// and automatically open that attraction's details.
final attraction =
...
// Multiple matches: open Cultural Map pre-filtered by the
// search text so the Tourist can pick from the full list.
await Navigator.of(context).push(
MaterialPageRoute(
builder: (_) =>
CulturalMapView(
